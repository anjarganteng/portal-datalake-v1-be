 ...
 */
@Entity
@Table(name = "tabel_post_employment_benefits_bot")
public class PostEmploymentBenefits{
    @Id
    ...
    public PostEmploymentBenefits() {
    }

    public PostEmploymentBenefits(String description, BigDecimal janMar, BigDecimal aprJun, BigDecimal julSep, BigDecimal octDec) {
    ...
    public PostEmploymentBenefits(String description) {
        this.description = description;
    }
