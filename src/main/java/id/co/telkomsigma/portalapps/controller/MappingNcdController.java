...
import id.co.telkomsigma.portalapps.service.MappingNcdService;
...
@CrossOrigin
@RestController
@RequestMapping(value = Constant.Path.MAPPING_NCD)
public class MappingNcdController {

    public Environment environment;
    public MappingNcdService mappingNcdService;

    @Autowired
    public MappingNcdController(
            Environment environment,
            MappingNcdService mappingNcdService
    ) {
        this.environment = environment;
        this.mappingNcdService = mappingNcdService;
    }
    ...
    public ResponseEntity<?> save(@RequestBody MappingNcdRequestDTO mappingNcdRequestDTO) {
        try {
            mappingNcdService.save(mappingNcdRequestDTO);
    ...
    public ResponseEntity<?> getAll() {
        try {
            return new ResponseEntity<>(Response.success(mappingNcdService.getAll()), HttpStatus.OK);
        } catch (Exception e) {
            e.printStackTrace();
            return new ResponseEntity<>(Response.failed(), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    ...
    public ResponseEntity<?> findAll(@RequestBody DataTablesInput dataTablesInput) {
        try {
            return new ResponseEntity<>(Response.success(mappingNcdService.findAll(dataTablesInput)), HttpStatus.OK);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public ResponseEntity<?> findById(@RequestParam(value = "id") String id) {
        try {
            ...
            return new ResponseEntity<>(Response.success(mappingNcdService.findById(id)), HttpStatus.OK);
        } catch (Exception e) {
            e.printStackTrace();
            return new ResponseEntity<>(Response.failed(), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    ...
    public ResponseEntity<?> deleteById(@RequestParam(value = "id") String id) {
        try {
            mappingNcdService.deleteById(id);
    ...
    public ResponseEntity<Resource> getFile() {
        String fileName = "Cif Ncd.xlsx";
        InputStreamResource file = new InputStreamResource(mappingNcdService.loadToExcel());
