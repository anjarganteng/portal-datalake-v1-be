...
import id.co.telkomsigma.portalapps.service.AtiService;
...
@CrossOrigin
@RestController
@RequestMapping(value = Constant.Path.ATI)
public class AtiController {

    public Environment environment;
    public AtiService atiService;

    @Autowired
    public AtiController(
    ...
    public ResponseEntity<?> save(@RequestBody AtiRequestDTO atiRequestDTO) {
        try {
            atiService.save(atiRequestDTO);
    ...
    public ResponseEntity<?> getAll() {
        try {
            return new ResponseEntity<>(Response.success(atiService.getAll()), HttpStatus.OK);
        } catch (Exception e) {
            e.printStackTrace();
            return new ResponseEntity<>(Response.failed(), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    ...
    public ResponseEntity<?> findAll(@RequestBody DataTablesInput dataTablesInput) {
        try {
            return new ResponseEntity<>(Response.success(atiService.findAll(dataTablesInput)), HttpStatus.OK);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public ResponseEntity<?> findById(@RequestParam(value = "id") String id) {
        try {
            ...
            return new ResponseEntity<>(Response.success(atiService.findById(id)), HttpStatus.OK);
        } catch (Exception e) {
            e.printStackTrace();
            return new ResponseEntity<>(Response.failed(), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    ...
    public ResponseEntity<Resource> getFile() {
        String fileName = "Ati.xlsx";
        InputStreamResource file = new InputStreamResource(atiService.loadToExcel());
