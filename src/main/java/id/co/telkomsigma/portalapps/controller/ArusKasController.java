...
import id.co.telkomsigma.portalapps.service.ArusKasService;
...
@CrossOrigin
@RestController
@RequestMapping(value = Constant.Path.ARUS_KAS)
public class ArusKasController {

    public Environment environment;
    public ArusKasService arusKasService;

    @Autowired
    public ArusKasController(
    ...
    public ResponseEntity<?> save(@RequestBody ArusKasRequestDTO arusKasRequestDTO) {
        try {
            arusKasService.save(arusKasRequestDTO);
    ...
    public ResponseEntity<?> getAll() {
        try {
            return new ResponseEntity<>(Response.success(arusKasService.getAll()), HttpStatus.OK);
        } catch (Exception e) {
            e.printStackTrace();
            return new ResponseEntity<>(Response.failed(), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    ...
    public ResponseEntity<?> findAll(@RequestBody DataTablesInput dataTablesInput) {
        try {
            return new ResponseEntity<>(Response.success(arusKasService.findAll(dataTablesInput)), HttpStatus.OK);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public ResponseEntity<?> findById(@RequestParam(value = "id") String id) {
        try {
            ...
            return new ResponseEntity<>(Response.success(arusKasService.findById(id)), HttpStatus.OK);
        } catch (Exception e) {
            e.printStackTrace();
            return new ResponseEntity<>(Response.failed(), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    ...
    public ResponseEntity<Resource> getFile() {
        String fileName = "Arus Kas.xlsx";
        InputStreamResource file = new InputStreamResource(arusKasService.loadToExcel());
