...
import id.co.telkomsigma.portalapps.service.CifToFiService;
...
@CrossOrigin
@RestController
@RequestMapping(value = Constant.Path.CIF_TO_FI)
public class CifToFiController {
    private CifToFiService service;

    public CifToFiController(CifToFiService service) {
    ...
    public ResponseEntity<Resource> getFile() {
        String fileName = "CIF TO FI.xlsx";
