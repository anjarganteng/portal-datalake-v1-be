...
import id.co.telkomsigma.portalapps.service.AtmService;
...
@CrossOrigin
@RestController
@RequestMapping(value = Constant.Path.ATM)
public class AtmController {

    public static final String MODULE_NAME = "atm";
    ...
    public ResponseEntity<?> save(@RequestBody AtmRequestDTO atmRequestDTO) {
        try {
            atmService.save(atmRequestDTO);
    ...
    //    @PreAuthorize("hasPermission('"+MODULE_NAME+"', 'read')")
    @PreAuthorize("hasPermission('is', 'read')")
    @GetMapping(value = Constant.Path.GET_ALL)
    public ResponseEntity<?> getAll() {
        try {
            return new ResponseEntity<>(Response.success(atmService.getAll()), HttpStatus.OK);
        } catch (Exception e) {
            e.printStackTrace();
            return new ResponseEntity<>(Response.failed(), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    ...
    public ResponseEntity<?> findAll(@RequestBody DataTablesInput dataTablesInput) {
        try {
            return new ResponseEntity<>(Response.success(atmService.findAll(dataTablesInput)), HttpStatus.OK);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public ResponseEntity<?> findById(@RequestParam(value = "id") String id) {
        try {
            ...
            return new ResponseEntity<>(Response.success(atmService.findById(id)), HttpStatus.OK);
        } catch (Exception e) {
            e.printStackTrace();
            return new ResponseEntity<>(Response.failed(), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    ...
    public ResponseEntity<Resource> getFile() {
        ...
        InputStreamResource file = new InputStreamResource(atmService.loadToExcel());
