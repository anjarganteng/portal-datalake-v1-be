...
import id.co.telkomsigma.portalapps.service.DeferredTaxService;
...
@CrossOrigin
@RestController
@RequestMapping(value = Constant.Path.DEFERRED_TAX)
public class DeferredTaxController {
    private DeferredTaxService service;

    public DeferredTaxController(DeferredTaxService service) {
    ...
    public ResponseEntity<Resource> getFile() {
        String fileName = "DEFERRED TAX.xlsx";
