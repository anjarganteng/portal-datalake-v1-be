...
import id.co.telkomsigma.portalapps.service.LiabilitasAntarKantorService;
...
@CrossOrigin
@RestController
@RequestMapping(value = Constant.Path.LIABILITAS_ANTAR_KANTOR)
public class LiabilitasAntarKantorController {

    public Environment environment;
    public LiabilitasAntarKantorService liabilitasAntarKantorService;
    public ProsesGenerateService prosesGenerateService;

    @Autowired
    public LiabilitasAntarKantorController(
            Environment environment,
            LiabilitasAntarKantorService liabilitasAntarKantorService,
            ProsesGenerateService prosesGenerateService
    ) {
        this.environment = environment;
        this.liabilitasAntarKantorService = liabilitasAntarKantorService;
    ...
    public ResponseEntity<?> save(@RequestBody LiabilitasAntarKantorRequestDTO liabilitasAntarKantorRequestDTO) {
        try {
            liabilitasAntarKantorService.save(liabilitasAntarKantorRequestDTO);
    ...
    public ResponseEntity<?> getAll() {
        try {
            return new ResponseEntity<>(Response.success(liabilitasAntarKantorService.getAll()), HttpStatus.OK);
        } catch (Exception e) {
            e.printStackTrace();
            return new ResponseEntity<>(Response.failed(), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    ...
    public ResponseEntity<?> findAll(@RequestBody DataTablesInput dataTablesInput) {
        try {
            return new ResponseEntity<>(Response.success(liabilitasAntarKantorService.findAll(dataTablesInput)), HttpStatus.OK);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public ResponseEntity<?> findById(@RequestParam(value = "id") String id) {
        try {
            ...
            return new ResponseEntity<>(Response.success(liabilitasAntarKantorService.findById(id)), HttpStatus.OK);
        } catch (Exception e) {
            e.printStackTrace();
            return new ResponseEntity<>(Response.failed(), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    ...
    public ResponseEntity<?> deleteById(@RequestParam(value = "id") String id) {
        try {
            liabilitasAntarKantorService.deleteById(id);
    ...
    public ResponseEntity<Resource> getFile() {
        String fileName = "Liabilitas Antar Kantor.xlsx";
        InputStreamResource file = new InputStreamResource(liabilitasAntarKantorService.loadToExcel());
