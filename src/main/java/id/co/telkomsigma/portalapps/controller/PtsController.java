...
import id.co.telkomsigma.portalapps.service.PtsService;
...
@CrossOrigin
@RestController
@RequestMapping(value = Constant.Path.PTS)
public class PtsController {
    ...
    public ResponseEntity<?> save(@RequestBody PtsRequestDTO ptsRequestDTO) {
        try {
            ptsService.save(ptsRequestDTO);
    ...
    public ResponseEntity<?> getAll() {
        try {
            return new ResponseEntity<>(Response.success(ptsService.getAll()), HttpStatus.OK);
        } catch (Exception e) {
            e.printStackTrace();
            return new ResponseEntity<>(Response.failed(), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    ...
    public ResponseEntity<?> findAll(@RequestBody DataTablesInput dataTablesInput) {
        try {
            return new ResponseEntity<>(Response.success(ptsService.findAll(dataTablesInput)), HttpStatus.OK);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public ResponseEntity<?> findById(@RequestParam(value = "id") String id) {
        try {
            ...
            return new ResponseEntity<>(Response.success(ptsService.findById(id)), HttpStatus.OK);
        } catch (Exception e) {
            e.printStackTrace();
            return new ResponseEntity<>(Response.failed(), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    ...
    public ResponseEntity<Resource> getFile() {
        String fileName = "Pts.xlsx";
        InputStreamResource file = new InputStreamResource(ptsService.loadToExcel());
