...
import id.co.telkomsigma.portalapps.service.LoanService;
...
@CrossOrigin
@RestController
@RequestMapping(value = Constant.Path.LOAN)
public class LoanController {
    ...
    public ResponseEntity<?> findAll(@RequestBody DataTablesInput dataTablesInput) {
        try {
            return new ResponseEntity<>(Response.success(loanService.findAll(dataTablesInput)), HttpStatus.OK);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public ResponseEntity<Resource> getFile() {
        ...
        InputStreamResource file = new InputStreamResource(loanService.loadToExcel());
