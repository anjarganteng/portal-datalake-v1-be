...
import id.co.telkomsigma.portalapps.service.SecuritiesService;
...
@CrossOrigin
@RestController
@RequestMapping(value = Constant.Path.SECURITIES)
public class SecuritiesController {
    ...
    public ResponseEntity<?> findAll(@RequestBody DataTablesInput dataTablesInput) {
        try {
            return new ResponseEntity<>(Response.success(securitiesService.findAll(dataTablesInput)), HttpStatus.OK);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public ResponseEntity<Resource> getFile() {
        ...
        InputStreamResource file = new InputStreamResource(securitiesService.loadToExcel());
