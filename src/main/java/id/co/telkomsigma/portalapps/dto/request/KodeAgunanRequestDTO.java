 ...
 * @author satiya
 */
public class KodeAgunanRequestDTO implements Serializable {

    private static final long serialVersionUID = -2015726178991599749L;
    ...
    public void setKodeAgunanAntasena(String kodeAgunanAntasena) {
        this.kodeAgunanAntasena = kodeAgunanAntasena.toUpperCase();
    }
    ...
    public void setKodeAgunanLps(String kodeAgunanLps) {
        this.kodeAgunanLps = kodeAgunanLps.toUpperCase();
    }
    ...
    public void setKodeAgunanSlik(String kodeAgunanSlik) {
        this.kodeAgunanSlik = kodeAgunanSlik.toUpperCase();
    }
